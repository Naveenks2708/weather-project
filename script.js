...
function renderToBody(data) {
  ...
  $(".current-temp").html(
    `<h1>${Math.round(data.list[0].main.temp)}<b>'</b><b>C</b></h1>`
  );
  $(".min-temp").html(
    `<h3>${Math.round(data.list[0].main.temp_min)}<b>'</b><b>C</b></h3>`
  );
  $(".max-temp").html(
    `<h3>${Math.round(data.list[0].main.temp_max)}<b>'</b><b>C</b></h3>`
  );
  $(".sec-row>ul>li:nth-child(1)").html(
    `<p class="dt-txt">${
      data.list[1].dt_txt
    ...
    )}<b>'</b><b>C</b></h3><h3>${Math.round(
      data.list[1].main.temp_max
    )}<b>'</b><b>C</b></h3></div> `
  );
  $(".sec-row>ul>li:nth-child(2)").html(
    `<p class="dt-txt">${
      data.list[2].dt_txt
    }</p><img src=http://openweathermap.org/img/wn/${
  ...
  $(".sec-row>ul>li:nth-child(3)").html(
    `<p class="dt-txt">${
      data.list[3].dt_txt
    }</p><img src=http://openweathermap.org/img/wn/${
  ...
  $(".sec-row>ul>li:nth-child(4)").html(
    `<p class="dt-txt">${
      data.list[4].dt_txt
    }</p><img src=http://openweathermap.org/img/wn/${
  ...
  $(".sec-row>ul>li:nth-child(5)").html(
    `<p class="dt-txt">${
      data.list[5].dt_txt
    }</p><img src=http://openweathermap.org/img/wn/${
